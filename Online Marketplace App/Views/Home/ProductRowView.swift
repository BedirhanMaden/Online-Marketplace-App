...
struct ProductRowView: View {
    ...
    var body: some View {
            ...
            }.frame(width: 350, height: 200, alignment: .center).background(Color("RowColor")).clipShape(.rect(cornerRadius: 20)).overlay(RoundedRectangle(cornerRadius: 20).stroke(.clear, lineWidth: 10))
            .shadow(radius: 20).padding(Spacing.spacing_3)
    }
}
